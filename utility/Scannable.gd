...
func _ready():
	...
	get_parent().connect("mouse_entered", ides, "_on_collision_mouse_entered", [get_parent()])
	get_parent().connect("mouse_exited", ides, "_on_collision_mouse_exited", [get_parent()])